    ...
    return (
      <div className="relative w-full mb-4">
        ...
        >
          ...
          <span className='text-white'>{options.find(option => option.iso_code === selectedValue.iso_code).name}</span>
          <svg className="w-4 h-4 ml-auto text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M7 10l5 5 5-5H7z"/></svg>
        </button>
        {isOpen && (
